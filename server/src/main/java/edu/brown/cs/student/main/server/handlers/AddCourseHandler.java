...
//       // Create a semester document with a dummy field (just in case we try to add a course to a
//       // semester that hasn't been created yet)
...
//         responseMap.put("error", "Prerequisites not met or course does not exist: " +
// courseCode);
...
//     if (node.type == PrereqTreeNode.Type.COURSE) return
// completedCourses.contains(node.courseCode);
