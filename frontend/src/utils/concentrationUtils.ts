...
const LOCAL_REQUIREMENTS: ConcentrationRequirements = {
  "Computer Science Sc.B.": {
    requirements_options: {
      ...
      "Linear Algebra (1)": ["MATH 0520", "MATH 0540", "CSCI 0530"],
      "Software Engineering (1)": ["CSCI 0320", "CSCI 1320"],
      "CSCI 1xxx/2xxx (2)": ["CSCI 1xxx", "CSCI 2xxx"],
      "External Course (3)": ["External courses approved by concentration advisor"],
      "Non-technical (1)": ["Any non-CS course"],
      "CSCI 1970 (2)": ["CSCI 1970"],
